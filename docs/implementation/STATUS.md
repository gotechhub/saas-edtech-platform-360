...
| EP03 | in_progress | Öğrenen için atanan/devam eden/tamamlanan eğitimler ve kaynak kütüphanesi; admin için genel bakış, kullanıcılar, eğitimler, programlar, dört adımlı atama, uyumluluk, rapor ve ayar ekranları çalışıyor. Beş rol navigasyonu, responsive UI, açık/koyu tema, Lucide ikonları ve özgün hukuk akademisi hero varlığı eklendi. Admin genel bakış metrikleri canlı Supabase/RLS verisinden gelir; ayrıntı tablolarının bir bölümü hâlâ sentetik ve tarayıcı yerelidir |
