...
- Supabase proje URL/public anahtarı yerel web ortamına bağlandı ve beş migration uzak veritabanına uygulandı; Auth test kullanıcısı, tenant üyeliği ve Storage kabulü henüz tamamlanmadı. RLS testinin Auth fixture'ı yalnızca test setup'ında bulunur, uygulamada kimlik doğrulama bypass'ı değildir.
