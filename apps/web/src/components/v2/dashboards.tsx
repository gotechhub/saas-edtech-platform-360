...
import { academyPrograms, complianceRows } from "@/lib/lms-data";
...
const activityTrend = [
  { label: "Pzt", value: 24, secondary: 18 },
  { label: "Sal", value: 31, secondary: 21 },
  { label: "Çar", value: 28, secondary: 24 },
  { label: "Per", value: 42, secondary: 29 },
  { label: "Cum", value: 38, secondary: 33 },
  { label: "Cmt", value: 18, secondary: 15 },
...
export function V2Dashboard(props: DashboardProps) {
  if (props.role === "learner") return <LearnerDashboard {...props} />;
  if (props.role === "admin") return <AdminDashboard {...props} />;
  if (props.role === "instructor") return <InstructorDashboard {...props} />;
